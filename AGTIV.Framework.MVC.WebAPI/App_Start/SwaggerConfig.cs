...
using AGTIV.Framework.MVC.WebAPI;
...
namespace AGTIV.Framework.MVC.WebAPI
{
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "AGTIV.Framework.MVC.WebAPI");
                        ...
                        c.BasicAuth("bearer")
                        .Description("Bearer HTTPS Authentication");
    ...
    public class AssignOAuth2SecurityRequirements : IOperationFilter
    {
        ...
        {
            { "bearerAuth", Enumerable.Empty<string>() }
        };
